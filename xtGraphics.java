...
public class xtGraphics extends Panel implements Runnable {
	...
	public Image credsnap(Image image) {
		...
		for (int k = 0; k < j * i; k++) {
			...
			int l = (int) (color.getRed() * (colors[0] / 100F));
			if (l > 225) {
				l = 225;
			}
			if (l < 0) {
			...
			int i1 = (int) (color.getGreen() * (colors[1] / 100F));
			if (i1 > 225) {
				i1 = 225;
			}
			if (i1 < 0) {
			...
			int j1 = (int) (color.getBlue() * (colors[2] / 100F));
			if (j1 > 225) {
				j1 = 225;
			}
			if (j1 < 0) {
	...
	public void loadnetworkimages() {
		dnload += 12;
		try {
			aimLogo = Utility.webGet("http://i59.servimg.com/u/f59/14/03/33/42/logo10.png");
		} catch (Exception exception) {
